  ...
  normalizeStashItemData(raw, type, game, league, validatedRates = {}) {
    ...
    for (const line of raw.lines) {
      ...
      results.push({
        ...
        corrupted: !!(line.corrupted || String(line.detailsId || '').includes('-corrupted') || String(line.variant || '').toLowerCase().includes('corrupted')),
        gemLevel: typeof line.gemLevel === 'number' ? line.gemLevel : null,
        gemQuality: typeof line.gemQuality === 'number' ? line.gemQuality : null,
